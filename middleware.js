...
//     const token = req.cookies.get('accessToken'); // assuming the access token is stored in a cookie
//     const { pathname } = req.nextUrl;

//     // Check if the user is trying to access the login or register page without being logged in
//     if (
...
//         if (token) {
//             try {
//                 // If the token is valid, redirect to the user's dashboard based on the role
...
//                 }
//             } catch (error) {
//                 // If token is invalid, do nothing and allow access to login/register
...
//         // Allow access to the respective dashboard based on role
